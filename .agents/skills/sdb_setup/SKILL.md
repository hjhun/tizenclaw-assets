---
name: SDB Setup
description: SDB (Smart Development Bridge) device and emulator setup workflow for Tizen development and debugging
---

# SDB (Smart Development Bridge) Development Skill

This skill defines the standard workflow for connecting to a Tizen Emulator or an actual device using SDB.
...
When the TizenClaw-Assets Agent needs to automatically set up the environment for development convenience, execute the following sequential commands (sh).
